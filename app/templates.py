    ...
    <div id="app">
        ...
        <div class="main-content">
            <div class="content-container">
                ...
                <div v-if="currentView === 'welcome-content'" class="welcome-container">
                ...
                <!-- Esperando Vehículos -->
                <div v-if="currentView === 'waiting-content'" class="waiting-data">
                    <h2>Sistema Activo</h2>
                    <p class="welcome-subtitle">Esperando detección de vehículos</p>
                </div>
                
                <!-- Error de Conexión -->
                <div v-if="currentView === 'error-connection'" class="error-connection">
                ...
                <div v-if="currentView === 'data-content'">
                    <div class="plate-container">
                        <h3 class="plate">[[ plateNumber ]]</h3>
                    </div>
                    
                    <div v-if="hasAppointment" class="info-section appointment-confirmed">
                    ...
                    <div v-else class="info-section no-appointment">
                        <div class="text-center mb-4">
                            <h2>NO TIENE CITA</h2>
                        </div>
                        <p class="no-appointment-message">[[ noAppointmentMessage ]]</p>
                    </div>
                </div>
            </div>
        </div>
